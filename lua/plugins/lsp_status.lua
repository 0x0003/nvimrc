-- https://github.com/rockyzhang24/dotfiles/blob/master/.config/nvim/lua/rockyz/lsp/progress.lua
...
local function get_win_row(pos)
  return vim.o.lines - vim.o.cmdheight - 1 - pos * 2
end
...
local function handler(args)
  ...
  if cur_client.is_done then
    cur_client.timer:start(1500, 100, vim.schedule_wrap(function()
...
local group = Aug('LspStatus', { clear = true })
Auc({ 'LspProgress' }, {
  group = group,
  pattern = '*',
